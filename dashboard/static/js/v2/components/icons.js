 ...
 * @param {string} name - Name des Icons (z.B. 'energy', 'house')
 * @param {number} size - Quadratische Größe in Pixeln (Standard 16)
 * @param {string} color - CSS-Farbe (Standard "currentColor")
 * @param {string} className - Optionale CSS-Klasse für Tailwind/CSS (Standard "")
 ...
 */
export function getAppleIcon(name, size = 16, color = 'currentColor', className = '', opacity = 1.0, marginRight = 0) {
  ...
  const svgLibrary = {
    ...
    sync: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38"/></svg>`,
    ...
    clock: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`,
    co2: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242M12 12v9m-4-4h8"/></svg>`,
    ...
    // --- ENERGIE- & GEBÄUDE-ICONS ---
    house: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>`,
    drop: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg>`,
    flame: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.07-2.14 0-5.5 3.5-7.5 0 0 .5 4 2 5s2.17 2.97 2.17 4.73A5.5 5.5 0 0 1 12 16.5a5.5 5.5 0 0 1-3.5-2z"/></svg>`,
    gas: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg>`,
    coin: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`,

    // --- HEIZUNG EXTRA ICONS ---
    warning: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
    checkCircle: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>`,
    xCircle: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`,
    broom: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M3 17h4v4H3zM10 11h4v10h-4zM17 6h4v15h-4z"/></svg>`,
    fuel: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M3 22V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v17"/><path d="M15 12h2a2 2 0 0 1 2 2v3a2 2 0 0 0 4 0V8l-4-3"/><rect x="5" y="7" width="8" height="5" rx="1"/></svg>`,
    thermo: `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"><path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"/></svg>`
  };

  return svgLibrary[name] || `<svg ${cls} style="${finalStyle}" viewBox="0 0 24 24"></svg>`;
}
